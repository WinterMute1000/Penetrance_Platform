"""
Django settings for penetrance_platform project.
...
SECRET_KEY = '7!+@vpkm7&jop(5o--+_mspkdt^wuc-n(9q7zsfi_-v$exzkrf'
...
WSGI_APPLICATION = 'penetrance_platform.config.wsgi.application'
